...
public class FilmDaoTestCase {
	...
	public void initDb() throws Exception {
	 ...
	 public void shouldListFilms() {
		 ...
		 assertThat(films).extracting("id", "title", "releaseDate", "genre.id", "duration", "director",
				 "summary").containsOnly(tuple(1 , "Title 1", LocalDate.parse("2015-11-26"), 1, 120, "director 1",
				 "summary of the first film"), tuple(2, "My Title 2", LocalDate.parse("2015-11-14"), 2, 114, "director 2",
				 "summary of the second film"), tuple(3, "Third title", LocalDate.parse("2015-12-12"), 2, 176, "director 3",
				 "summary of the third film"));
	 }
	 ...
	 public void shouldListFilmsByGenre() {
		 ...
		 assertThat(film).extracting("id", "title", "releaseDate", "genre.id", "duration", "director",
				 "summary").containsOnly(tuple(1, "Title 1", LocalDate.parse("2015-11-26"), 1, 120, "director 1",
	 ...
	 public void shouldAddFilm() throws Exception {
		 // WHEN
		 filmDao.addFilm(new Film(4,"Current Title 4", LocalDate.parse("2021-02-07"),
				 new Genre(1, "Drama"), 168, "director 4", "summary of the fourth film"));
		 // THEN
		 Connection connection = DataSourceFactory.getDataSource().getConnection();
		 Statement statement = connection.createStatement();
		 ResultSet resultSet = statement.executeQuery("SELECT * FROM film WHERE title='Current Title 4'");
		 assertThat(resultSet.next()).isTrue();
		 assertThat(resultSet.getInt("idfilm")).isNotNull();
		 assertThat(resultSet.getString("title")).isEqualTo("Current Title 4");
		 assertThat(resultSet.getDate("release_date")).isEqualTo(Date.valueOf("2021-02-07"));
		 assertThat(resultSet.getInt("genre_id")).isEqualTo(1);
		 assertThat(resultSet.getInt("duration")).isEqualTo(168);
